...
@NamedNativeQuery(
	 name = "ChildListEnhanced.getChildEnhancedList", 
     resultClass = ChildListEnhanced.class, 
     query = "select cb.childno, cb.ChildID , cb.RHNo, cb.EducationStatus , cb.FirstName,  cm_filter.childStatusDate,cs.ChildStatus, ISNULL(pde.ProfileStatusFlag, 'Y') as profileStatusFlag "
